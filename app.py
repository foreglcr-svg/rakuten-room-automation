...
# 月ごとの季節キーワード(時期で可変)。ターゲット層が実名で指名買いするブランド/定番を軽く1つ足す用途。
SEASONAL_KEYWORDS = {
    1: ["ノースフェイス ダウン", "チャンピオン スウェット 裏起毛", "ニットキャップ ハイランド"],
    2: ["パタゴニア レトロX フリース", "ダウンベスト テック", "ウールニット メンズ"],
    3: ["グラミチ パンツ", "チャンピオン パーカー", "デニムジャケット リーバイス"],
    4: ["ノースフェイス マウンテンパーカー", "オアスロウ シャツ", "コンバース チャックテイラー"],
    5: ["オープンカラーシャツ 開襟", "チャコ サンダル", "グラミチ ショートパンツ"],
    6: ["アロハシャツ レーヨン", "テバ サンダル", "バケットハット ノースフェイス"],
    7: ["アロハシャツ メンズ", "グラミチ ショートパンツ", "キーン サンダル"],
    8: ["開襟シャツ 半袖", "チャコ サンダル", "パタゴニア バギーズ"],
    9: ["チャンピオン リバースウィーブ", "リーバイス コーデュロイ", "ネルシャツ 厚手"],
    10: ["ウールリッチ フランネル", "ダウンベスト パタゴニア", "レッドウィング ブーツ"],
    11: ["ノースフェイス ヌプシ", "ケーブルニット", "ダナー ブーツ"],
    12: ["ノースフェイス バルトロ", "ニットキャップ", "レザーグローブ"],
}
...
FALLBACK_TEMPLATES = [
    ("👕 これは間違いない。分かってる人向けの一枚。",
     "素材感とディテールに無骨な良さがあって、Tシャツやデニムの普段使いにさらっとハマる。使い込むほど味が出るタイプで、長く付き合える相棒になるはず。",
     "お買い物マラソンの候補にぜひどうぞ。"),
    ("🧢 定番にこそ、こだわりを。渋いやつ見つけた。",
     "流行り廃りに左右されない普遍的な佇まいが魅力。経年変化を楽しみながら、雑に使い込むほど雰囲気が出てくる一着。",
     "気になったら詳細をチェックしてみて。"),
    ("👟 これ、足元から効いてくる。大人の抜け感。",
     "作りの良さとタフさが両立していて、ワンマイルから旅先までガシガシ使える。シンプルな装いに合わせるだけで様になる。",
     "次の買い回り候補にぜひ。"),
    ("🎒 道具としての本質がある一本。長く付き合える。",
     "質実剛健なつくりと、街に馴染む佇まいのバランスが絶妙。無骨さの中に品があって、こういうモノは飽きずに使える。",
     "この機会にぜひチェックを。"),
]
