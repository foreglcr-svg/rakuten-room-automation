...
# 月ごとの「今の気分」のファッション・トレンドキーワード(時期で可変)。
# 家電や湿気対策のような地味な時期依存品ではなく、季節のおしゃれ小物を軽く1つ足す用途。
SEASONAL_KEYWORDS = {
    1: ["ニット帽 おしゃれ", "福袋 レディース ファッション", "大判 ストール"],
    2: ["マフラー 大判 レディース", "レザー 手袋", "ニット カーディガン"],
    3: ["春 アウター レディース", "薄手 ストール", "トレンチコート"],
    4: ["トレンチコート レディース", "かごバッグ おしゃれ", "スカーフ 巻き方"],
    5: ["リネン シャツ レディース", "サングラス おしゃれ", "かごバッグ 夏"],
    6: ["リネン ワンピース", "レインシューズ おしゃれ", "かごバッグ 大きめ"],
    7: ["麦わら帽子 レディース", "サンダル おしゃれ", "リネン シャツ 半袖"],
    8: ["麦わら帽子 おしゃれ", "サングラス レトロ", "浴衣 レトロ"],
    9: ["秋 ニット レディース", "ベレー帽 おしゃれ", "秋 ストール"],
    10: ["コーデュロイ パンツ", "ベレー帽 レディース", "レザー ブーツ"],
    11: ["ニット マフラー", "レザー 手袋 レディース", "ボア ジャケット"],
    12: ["ニット帽 レディース", "ボア ジャケット", "クリスマス アクセサリー"],
}
